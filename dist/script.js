...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggle]').modal();
...
$.prototype.init = function (selector) {
  ...
  return this; // содерж.прототипы, эл-ты , с кот. будем взаимод.
};
...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
 ...
 // метод, изменяющий html-структуру внутри элемента, а также получающий содержимое данного эл-та
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.eq = function (i) {
  ...
  this.length = 1;
  return this;
}; // Получение номер эл-та по порядку cреди эл-тов c общим родителем
...
}; // Нахождение определённых эл-тов среди уже выбранных
